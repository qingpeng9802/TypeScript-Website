...
type GetDocumentBySlugQuery = { readonly mdx: { readonly id: string, readonly excerpt: string | null, readonly tableOfContents: Record<string, unknown> | null, readonly frontmatter: { readonly permalink: string | null, readonly title: string | null, readonly disable_toc: boolean | null, readonly handbook: string | null, readonly oneline: string | null, readonly preamble: string | null, readonly deprecated_by: string | null, readonly deprecation_redirects: ReadonlyArray<string | null> | null, readonly experimental: boolean | null } | null } | null, readonly prev: { readonly childMdx: { readonly frontmatter: { readonly title: string | null, readonly oneline: string | null, readonly permalink: string | null } | null } | null } | null, readonly next: { readonly childMdx: { readonly frontmatter: { readonly title: string | null, readonly oneline: string | null, readonly permalink: string | null } | null } | null } | null };
